...
STYCRV: constant(address) =     0x27B5739e22ad9033bcBf192059122d163b60349D # ST-YCRV # @audit - rename to yvyCRV
...
@external
def __init__():
    self.name = "YCRV Zap v3" # @audit - this should be updated to v4
